    ...
    public R info(@PathVariable("id") Long id, HttpServletRequest request){
        ...
        if(cart !=null){
            ...
            BeanUtils.copyProperties( cart , view );//把实体数据重构到view中
                ...
                //级联表
                ChuandaEntity chuanda = chuandaService.selectById(cart.getChuandaId());
                if(chuanda != null){
    ...
    */
    ...
    public R save(@RequestBody CartEntity cart, HttpServletRequest request){
        ...
        Wrapper<CartEntity> queryWrapper = new EntityWrapper<CartEntity>()
            ...
            .eq("chuanda_id", cart.getChuandaId())
...
//                            cartEntity.setChuandaId(Integer.valueOf(data.get(0)));   //穿搭 要改的
