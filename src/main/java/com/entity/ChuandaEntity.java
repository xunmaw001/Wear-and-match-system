 ...
 */
@TableName("chuanda")
public class ChuandaEntity<T> implements Serializable {
    ...
    public String toString() {
        return "Chuanda{" +
            "id=" + id +
            ", chuandaName=" + chuandaName +
            ", chuandaPhoto=" + chuandaPhoto +
            ", chuandaTypes=" + chuandaTypes +
            ", fenggeTypes=" + fenggeTypes +
            ", changheTypes=" + changheTypes +
            ", shencaiTypes=" + shencaiTypes +
            ", chuandaKucunNumber=" + chuandaKucunNumber +
            ", chuandaPrice=" + chuandaPrice +
            ", chuandaOldMoney=" + chuandaOldMoney +
            ", chuandaNewMoney=" + chuandaNewMoney +
            ", chuandaClicknum=" + chuandaClicknum +
            ", shangxiaTypes=" + shangxiaTypes +
            ", chuandaDelete=" + chuandaDelete +
            ", chuandaContent=" + chuandaContent +
