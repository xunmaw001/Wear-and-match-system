...
public class ChuandaCommentbackView extends ChuandaCommentbackEntity implements Serializable {
	...
	public ChuandaCommentbackView() {

	}

	public ChuandaCommentbackView(ChuandaCommentbackEntity chuandaCommentbackEntity) {
		try {
			BeanUtils.copyProperties(this, chuandaCommentbackEntity);
