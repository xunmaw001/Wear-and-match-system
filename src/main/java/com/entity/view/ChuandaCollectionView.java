...
public class ChuandaCollectionView extends ChuandaCollectionEntity implements Serializable {
    private static final long serialVersionUID = 1L;

		/**
		* 类型的值
		*/
		private String chuandaCollectionValue;
	...
	public ChuandaCollectionView() {

	}

	public ChuandaCollectionView(ChuandaCollectionEntity chuandaCollectionEntity) {
		try {
			BeanUtils.copyProperties(this, chuandaCollectionEntity);
			...
			* 获取： 类型的值
			*/
			public String getChuandaCollectionValue() {
				return chuandaCollectionValue;
			}
			/**
			* 设置： 类型的值
			*/
			public void setChuandaCollectionValue(String chuandaCollectionValue) {
				this.chuandaCollectionValue = chuandaCollectionValue;
			}
