...
public class ChuandajiangtangLiuyanView extends ChuandajiangtangLiuyanEntity implements Serializable {
	...
	public ChuandajiangtangLiuyanView() {

	}

	public ChuandajiangtangLiuyanView(ChuandajiangtangLiuyanEntity chuandajiangtangLiuyanEntity) {
		try {
			BeanUtils.copyProperties(this, chuandajiangtangLiuyanEntity);
