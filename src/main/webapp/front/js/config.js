...
var centerMenu = [
    ...
    ,{
        name: '穿搭收藏',
        url: '../chuandaCollection/list.html'
    }
    ,{
        name: '穿搭订单',
        url: '../chuandaOrder/list.html'
    }
    ,{
        name: '穿搭讲堂收藏',
        url: '../chuandajiangtangCollection/list.html'
    }
...
var indexNav = [
    ...
    {
        name: '穿搭',
        url: './pages/chuanda/list.html'
    },
    {
        name: '穿搭讲堂',
        url: './pages/chuandajiangtang/list.html'
    },
    {
        name: '论坛',
...
var adminurl =  "http://localhost:8080/chuandaidapei/admin/dist/index.html#/login";
